                ...
                <div className='w-full max-w-3xl'>
                    {
                        loading ? (
                            ...
                            data.map((product, index) => {
                                return (
                                    <div key={product?._id + "Add To Cart Loading"} className='w-full bg-white my-2 border border-slate-300 rounded grid grid-cols-1 sm:grid-cols-[128px,1fr] relative'>
                                        <div className='w-full sm:w-32 h-32 bg-slate-200'>
                                            <img src={product?.productId?.productImage[0]} className='w-full h-full object-scale-down mix-blend-multiply' />
                                        </div>
                                        <div className='px-4 py-2 relative flex flex-col justify-between h-full'>
                                            <div>
                                            ...
                                            {/**delete product */}
                                            <div className='absolute bottom-2 right-2 text-red-600 rounded-full p-2 hover:bg-red-600 hover:text-white cursor-pointer' onClick={() => deleteCartProduct(product?._id)}>
                                                <MdDelete />
                                            </div>
                                        </div>
                                    </div>
