         ...
         <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
          ...
          {/**product details */}
          {
            loading ? (
              ...
              <h2 className='text-2xl lg:text-2xl font-medium justify-text h-6 lg:h-8 bg-slate-200 animate-pulse w-full'></h2>
              ...
              <div className='flex items-center gap-2 text-lg font-medium my-1 h-6 lg:h-8 animate-pulse w-full'>
              ...
              <h2 className='text-2xl lg:text-2xl lg:justify-text font-medium'>{data?.productName}</h2>
              ...
              <div className='flex items-center gap-2 text-lg font-medium my-1'>
              ...
              <div>
                ...
                <p className='justify-text'>{data?.description}</p>
              </div>
              </div>
            )
          }
