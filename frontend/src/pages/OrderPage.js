...
const OrderPage = () => {
  ...
  const [showOrders, setShowOrders] = useState(false); // State to manage visibility of orders
  ...
  return (
    <div>
      {/* Button to toggle order visibility on mobile */}
      ...
      {/* Orders List */}
      {showOrders && ( // Conditionally render order details based on state
